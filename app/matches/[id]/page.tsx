...
export default function MatchDetailPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0b0f14] text-white pb-10">
      <header className="border-b border-slate-800 bg-[#0f141b]">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between gap-3">
          <Link
            href="/"
            className="text-xs font-bold text-slate-400 hover:text-white whitespace-nowrap"
          >
            ← Maçlara Dön
          </Link>
...
function SubTabButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`px-4 py-2 rounded-xl text-xs font-extrabold tracking-wider transition-all whitespace-nowrap ${
        active
